...
SELECT  Alugueis.IdAluguel, Alugueis.DataInicio,Alugueis.Nome,Alugueis.DataFim,Alugueis.IdVeiculo
from Alugueis INNER JOIN Alugueis ON Clientes.IdCliente=Alugueis.IdCliente
INNER JOIN Veiculos ON Alugueis.IdAluguel = Veiculos.IdVeiculo WHERE Veiculos.IdVeiculo = 3